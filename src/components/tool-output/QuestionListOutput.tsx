...
function getQuestionKey(question: QuestionListItem) {
  return `${question.header || "question"}:${question.question}`;
}

function getOptionKey(question: QuestionListItem, optionLabel: string) {
  return `${question.question}:${optionLabel}`;
}
        ...
        >
          ...
          <div className="space-y-2 p-3">
            {question.options.map((option) => {
              ...
              return (
                <div
                  key={getOptionKey(question, option.label)}
